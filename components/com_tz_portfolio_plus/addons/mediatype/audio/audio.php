...
class PlgTZ_Portfolio_PlusMediaTypeAudio extends TZ_Portfolio_PlusPlugin
{
                ...
                if(isset($media -> audio)){
                    ...
                    if(isset($audio -> type) && $audio -> type == 'soundcloud'){
                        if(isset($audio -> code) && !empty($audio -> code)) {
                            ...
                            $audio->url = 'http://w.soundcloud.com/player/?url=' . urlencode('http://api.soundcloud.com/tracks/'
                                    . $audio->code) . $audioOption;
                        }
                    }
                    $this -> setVariable('audio', $audio);
                }
            }
