        ...
        <span class="rating">
            <a href="javascript:void(null)"
               ...
               1);"
                ...
                class="rating-item muted fa fa-star<?php echo (($count > 4)?' voted':'')?>">
                <?php if($count > 4 && $count < 5){?>
                <span class="fa fa-star" style="width: <?php echo round(100 - ($count - 4)*100);?>%"></span>
                <?php }?>
               ...
               1);"
                ...
                class="rating-item muted fa fa-star<?php echo (($count > 3)?' voted':'')?>">
                <?php if( $count > 3 && $count < 4){?>
                <span class="fa fa-star" style="width: <?php echo round(100 - ($count - 3)*100);?>%"></span>
                <?php }?>
            </a><a href="javascript:void(null)"
               ...
               1);"
                ...
                class="rating-item muted fa fa-star<?php echo (($count > 2)?' voted':'')?>">
                <?php if( $count > 2 && $count < 3){?>
                <span class="fa fa-star" style="width: <?php echo round(100 - ($count - 2)*100);?>%"></span>
                <?php }?>
            </a><a href="javascript:void(null)"
               ...
               1);"
                ...
                class="rating-item muted fa fa-star<?php echo (($count > 1)?' voted':'')?>">
                <?php if( $count > 1 && $count < 2){?>
                <span class="fa fa-star" style="width: <?php echo round(100 - ($count - 1)*100);?>%"></span>
                <?php }?>
            </a><a href="javascript:void(null)"
               ...
               1);"
                ...
                class="rating-item muted fa fa-star<?php echo (($count > 0)?' voted':'')?>">
                <?php if( $count > 0 && $count < 1){?>
                <span class="fa fa-star" style="width: <?php echo round(100 - ($count - 0)*100);?>%"></span>
                <?php }?>
            </a>
        </span>
