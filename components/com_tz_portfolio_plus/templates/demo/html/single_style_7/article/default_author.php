...
<?php if (!empty($this->item->author )) : ?>
    ...
    <?php if ($params->get('link_author', 1)): ?>
        ...
        ?>
        <?php echo JText::sprintf('TPL_TZ_PORTFOLIO_PLUS_WRITTEN_BY', JHtml::_('link', JRoute::_($cntlink), $author,$target.' itemprop="url"')); ?>
    <?php else: ?>
        <?php echo JText::sprintf('TPL_TZ_PORTFOLIO_PLUS_WRITTEN_BY', $author); ?>
    <?php endif; ?>
</span>
<?php endif; ?>