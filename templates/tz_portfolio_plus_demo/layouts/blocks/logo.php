...
<?php if ($this->getParam('logo_type', 'image')!=='none'): ?>
     ...
     <a href="<?php echo 'http://tzportfolio.com';?>" id="tzlogo" class="pull-left css-logo">
     	<?php echo $logo_text . ' - ' . $logo_slogan; ?>
     </a>
     <?php elseif($this->getParam('logo_type', 'image')=='text') : ?>
     <a href="<?php echo 'http://tzportfolio.com';?>" id="tzlogo" class="text-logo pull-left">
     ...
     <a href="<?php echo 'http://tzportfolio.com';?>" id="tzlogo">
